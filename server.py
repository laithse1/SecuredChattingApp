...
# Function to choose which security algorithm to use
def chooseMethod():
    lst = ["DES", "ELGAMAL", "RSA"]
    print("---------Welcome to our secure chat")
    print("1- DES (Data encryption standard)")
    print("2- ElGamal encryption algorithm")
    print("3- RSA (Rivest–Shamir–Adleman)")
    num = input("Choose the encryption algorithm: ")
...
def main():
    global ElgamalKey
    ElgamalKey = el_gamal_Algo.generate_public_key()
